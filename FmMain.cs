...
namespace 天若OCR文字识别
{
	...
	public partial class FmMain : Form
	{
		...
		// Token: 0x06000080 RID: 128 RVA: 0x000024AC File Offset: 0x000006AC
		public void tray_limit_Click(object sender, EventArgs e)
		{
			new Thread(new ThreadStart(this.about)).Start();
		}

		// Token: 0x06000081 RID: 129 RVA: 0x00009758 File Offset: 0x00007958
		...
		// Token: 0x06000082 RID: 130 RVA: 0x000024C4 File Offset: 0x000006C4
		public bool own_punctuation(string text)
		{
			return ",;，、<>《》()-（）.。".IndexOf(text) != -1;
		}

		// Token: 0x06000083 RID: 131 RVA: 0x00009790 File Offset: 0x00007990
		...
		// Token: 0x06000084 RID: 132 RVA: 0x000024D7 File Offset: 0x000006D7
		...
		// Token: 0x06000086 RID: 134 RVA: 0x00009A18 File Offset: 0x00007C18
		...
		// Token: 0x06000087 RID: 135 RVA: 0x000024E4 File Offset: 0x000006E4
		...
		// Token: 0x06000088 RID: 136 RVA: 0x00002502 File Offset: 0x00000702
		...
		// Token: 0x06000089 RID: 137 RVA: 0x00002520 File Offset: 0x00000720
		...
		// Token: 0x0600008A RID: 138 RVA: 0x00009AAC File Offset: 0x00007CAC
		...
		// Token: 0x0600008B RID: 139 RVA: 0x00009C50 File Offset: 0x00007E50
		...
		// Token: 0x0600008C RID: 140 RVA: 0x00009D00 File Offset: 0x00007F00
		...
		// Token: 0x0600008D RID: 141 RVA: 0x0000253E File Offset: 0x0000073E
		public bool contain(string text, string subStr)
		{
			return text.Contains(subStr);
		}

		// Token: 0x0600008E RID: 142 RVA: 0x000022B0 File Offset: 0x000004B0
		public static bool contain_en(string str)
		{
			return Regex.IsMatch(str, "[a-zA-Z]");
		}

		// Token: 0x0600008F RID: 143 RVA: 0x00009D6C File Offset: 0x00007F6C
		...
		// Token: 0x06000090 RID: 144 RVA: 0x00002547 File Offset: 0x00000747
		public string quotation(string str)
		{
			return Regex.Replace(str.Replace("“", "\"").Replace("”", "\""), "(?<=\")([^\\\"\\“\\”]+)(?=\")", "$1_测_$2");
		}

		// Token: 0x06000091 RID: 145 RVA: 0x00009D98 File Offset: 0x00007F98
		...
		// Token: 0x06000092 RID: 146 RVA: 0x00009E24 File Offset: 0x00008024
		...
		// Token: 0x06000093 RID: 147 RVA: 0x00009E40 File Offset: 0x00008040
		...
		// Token: 0x06000094 RID: 148 RVA: 0x00002577 File Offset: 0x00000777
		public void TTS()
		{
			new Thread(new ThreadStart(this.TTS_thread)).Start();
		}

		// Token: 0x06000095 RID: 149 RVA: 0x0000258F File Offset: 0x0000078F
		public void about()
		{
			base.WindowState = FormWindowState.Minimized;
			Control.CheckForIllegalCrossThreadCalls = false;
		...
		// Token: 0x06000096 RID: 150 RVA: 0x0000207C File Offset: 0x0000027C
		...
		// Token: 0x06000098 RID: 152 RVA: 0x00009E98 File Offset: 0x00008098
		public void TTS_thread()
		{
			try
			{
				...
				responseStream.Close();
				string str;
				if (!FmMain.contain_ch(this.htmltxt.ToString()))
				{
					str = "zh";
				}
				else
				...
				{
					"http://tsn.baidu.com/text2audio?lan=" + str + "&ctp=1&cuid=abcdxxx&tok=",
					((JObject)JsonConvert.DeserializeObject(value))["access_token"].ToString(),
					"&tex=",
					HttpUtility.UrlEncode(this.htmltxt.Replace("***", "").ToString()),
		...
		// Token: 0x06000099 RID: 153 RVA: 0x0000A0A4 File Offset: 0x000082A4
		...
		// Token: 0x0600009B RID: 155 RVA: 0x0000A150 File Offset: 0x00008350
		...
		// Token: 0x0600009C RID: 156 RVA: 0x0000A238 File Offset: 0x00008438
		public string Translate_Google(string text)
		{
			...
			try
			{
				...
				JArray jarray = (JArray)JsonConvert.DeserializeObject(httpHelper.GetHtml(item).Html);
		...
		// Token: 0x0600009D RID: 157 RVA: 0x0000A440 File Offset: 0x00008640
		...
		// Token: 0x0600009E RID: 158 RVA: 0x0000A4C4 File Offset: 0x000086C4
		public string ScanQRCode()
		{
			string result = "";
			try
			{
				BinaryBitmap image = new BinaryBitmap(new HybridBinarizer(new BitmapLuminanceSource((Bitmap)this.image_screen)));
				Result result2 = new QRCodeReader().decode(image);
				if (result2 != null)
				{
					result = result2.Text;
				}
		...
		// Token: 0x0600009F RID: 159 RVA: 0x000025EC File Offset: 0x000007EC
		...
		public string Get_Betweenstr(string forward, string after, string input)
		{
			return new Regex(string.Concat(new string[]
			{
				...
				after,
				"))"
			}), RegexOptions.Multiline | RegexOptions.Singleline).Match(input).Value;
		}

		// Token: 0x060000A2 RID: 162 RVA: 0x0000A610 File Offset: 0x00008810
		public void check_update()
		{
			Program.Get_version("http://cc.ys168.com/f_ht/ajcx/ml.aspx?cz=ml_dq&_dlmc=tianruoyouxin&_dlmm=");
			string tipTitle = "提醒";
			string tipText = "发现新版本请点击托盘更新！";
			if (new Version(Program.version_url) > new Version(StaticValue.current_v))
			{
				this.minico.ShowBalloonTip(300, tipTitle, tipText, ToolTipIcon.Info);
			}
		}

		// Token: 0x060000A3 RID: 163 RVA: 0x0000266B File Offset: 0x0000086B
		public static bool contain_jap(string str)
		{
			return Regex.IsMatch(str, "[\\u3040-\\u309F]") || Regex.IsMatch(str, "[\\u30A0-\\u30FF]");
		}

		// Token: 0x060000A4 RID: 164 RVA: 0x00002687 File Offset: 0x00000887
		public static bool contain_kor(string str)
		{
			return Regex.IsMatch(str, "[\\uac00-\\ud7ff]");
		}

		// Token: 0x060000A5 RID: 165 RVA: 0x0000A664 File Offset: 0x00008864
		...
		// Token: 0x060000A7 RID: 167 RVA: 0x0000A6C4 File Offset: 0x000088C4
		...
		// Token: 0x060000A8 RID: 168 RVA: 0x0000A8B8 File Offset: 0x00008AB8
		...
		// Token: 0x060000A9 RID: 169 RVA: 0x0000A918 File Offset: 0x00008B18
		public static string ReFileName(string strFolderPath, string strFileName)
		{
			...
			int num = 1;
			string path = string.Format(text, num);
		...
		// Token: 0x060000AA RID: 170 RVA: 0x0000A978 File Offset: 0x00008B78
		...
		// Token: 0x060000AB RID: 171 RVA: 0x000026AB File Offset: 0x000008AB
		...
		// Token: 0x060000AC RID: 172 RVA: 0x000026EB File Offset: 0x000008EB
		...
		// Token: 0x060000AD RID: 173 RVA: 0x0000A9C8 File Offset: 0x00008BC8
		...
		// Token: 0x060000AE RID: 174 RVA: 0x0000AA54 File Offset: 0x00008C54
		...
		// Token: 0x060000AF RID: 175 RVA: 0x0000AA90 File Offset: 0x00008C90
		...
		// Token: 0x060000B0 RID: 176 RVA: 0x0000272B File Offset: 0x0000092B
		...
		// Token: 0x060000B1 RID: 177 RVA: 0x00002755 File Offset: 0x00000955
		...
		// Token: 0x060000B2 RID: 178 RVA: 0x0000277F File Offset: 0x0000097F
		...
		// Token: 0x060000B3 RID: 179 RVA: 0x000027A9 File Offset: 0x000009A9
		...
		// Token: 0x060000B4 RID: 180 RVA: 0x0000AACC File Offset: 0x00008CCC
		...
		// Token: 0x060000B5 RID: 181 RVA: 0x0000AB24 File Offset: 0x00008D24
		...
		// Token: 0x060000B8 RID: 184 RVA: 0x000027D3 File Offset: 0x000009D3
		...
		// Token: 0x060000B9 RID: 185 RVA: 0x0000AC70 File Offset: 0x00008E70
		public string Google_Hotkey(string text)
		{
			...
			try
			{
				...
				JArray jarray = (JArray)JsonConvert.DeserializeObject(this.Get_GoogletHtml(url));
				int count = ((JArray)jarray[0]).Count;
				for (int i = 0; i < count; i++)
				{
					text2 += jarray[0][i][0].ToString();
		...
		// Token: 0x060000BA RID: 186 RVA: 0x0000AD80 File Offset: 0x00008F80
		...
		// Token: 0x060000BB RID: 187 RVA: 0x0000AE00 File Offset: 0x00009000
		...
		// Token: 0x060000BC RID: 188 RVA: 0x0000AEB8 File Offset: 0x000090B8
		...
		// Token: 0x060000BD RID: 189 RVA: 0x0000AF98 File Offset: 0x00009198
		...
		// Token: 0x060000BE RID: 190 RVA: 0x0000B088 File Offset: 0x00009288
		...
		// Token: 0x060000BF RID: 191 RVA: 0x0000B164 File Offset: 0x00009364
		public void Main_OCR_Quickscreenshots()
		{
			if (!StaticValue.截图排斥)
			{
				try
				{
					...
					if (mode_flag == "高级截图")
					{
						RegionCaptureMode mode = RegionCaptureMode.Annotation;
						RegionCaptureOptions options = new RegionCaptureOptions();
						using (RegionCaptureForm regionCaptureForm = new RegionCaptureForm(mode, options))
						{
					...
					if (mode_flag == "贴图")
					{
						Point locationPoint = new Point(point.X, point.Y);
						new FmScreenPaste(this.image_screen, locationPoint).Show();
						if (inihelp.GetValue("快捷键", "翻译文本") != "请按下快捷键")
						{
							string value = inihelp.GetValue("快捷键", "翻译文本");
							string text = "None";
					...
					else if (mode_flag == "区域多选")
					{
						...
						else
						{
							...
							this.thread.Start();
							this.ts = new TimeSpan(DateTime.Now.Ticks);
							this.getSubPics_ocr(this.image_screen, buildRects);
						}
					}
					...
					else
					{
						...
						{
							string filename = inihelp.GetValue("配置", "截图位置") + "\\" + FmMain.ReFileName(inihelp.GetValue("配置", "截图位置"), "图片.Png");
							this.image_screen.Save(filename, ImageFormat.Png);
							StaticValue.截图排斥 = false;
						...
						{
							this.getSubPics(this.image_screen, buildRects);
							StaticValue.截图排斥 = false;
							if (inihelp.GetValue("截图音效", "自动保存") == "True")
							{
								this.PlaySong(inihelp.GetValue("截图音效", "音效路径"));
						...
						else if (mode_flag == "保存")
						{
							...
							if (inihelp.GetValue("快捷键", "翻译文本") != "请按下快捷键")
							{
								...
								string text11 = "None";
								string text12 = "F9";
								this.SetHotkey(text11, text12, value6, 205);
							}
							HelpWin32.UnregisterHotKey(base.Handle, 222);
							StaticValue.截图排斥 = false;
						}
		...
		// Token: 0x060000C0 RID: 192 RVA: 0x0000BBBC File Offset: 0x00009DBC
		public void Main_OCR_Thread()
		{
			...
			if (this.interface_flag == "从左向右" || this.interface_flag == "从右向左")
			{
				...
				Image<Bgr, byte> draw = image3.Convert<Bgr, byte>();
				Image<Gray, byte> image4 = image3.Clone();
				CvInvoke.Canny(image3, image4, 0.0, 0.0, 5, true);
				this.select_image(image4, draw);
				bitmap.Dispose();
				image2.Dispose();
				image3.Dispose();
			}
		...
		// Token: 0x060000C1 RID: 193 RVA: 0x0000BED0 File Offset: 0x0000A0D0
		public void Main_OCR_Thread_last()
		{
			...
			if (this.baidu_flags == "百度")
			{
				...
				if (inihelp.GetValue("快捷键", "翻译文本") != "请按下快捷键")
				{
					...
					string text2 = "None";
					string text3 = "F9";
					this.SetHotkey(text2, text3, value, 205);
				}
				HelpWin32.UnregisterHotKey(base.Handle, 222);
				return;
			}
			...
			if (inihelp.GetValue("快捷键", "翻译文本") != "请按下快捷键")
			{
				...
				string text6 = "None";
				string text7 = "F9";
				this.SetHotkey(text6, text7, value3, 205);
			}
			HelpWin32.UnregisterHotKey(base.Handle, 222);
			this.RichBoxBody.Refresh();
		}

		// Token: 0x060000C2 RID: 194 RVA: 0x000027F8 File Offset: 0x000009F8
		private void OCR_baidu_Ch_and_En_Click(object sender, EventArgs e)
		{
			this.OCR_foreach("中英");
		}

		// Token: 0x060000C3 RID: 195 RVA: 0x00002805 File Offset: 0x00000A05
		...
		// Token: 0x060000C5 RID: 197 RVA: 0x0000C42C File Offset: 0x0000A62C
		...
		// Token: 0x060000C6 RID: 198 RVA: 0x0000C53C File Offset: 0x0000A73C
		public void OCR_baidu()
		{
			...
			try
			{
				...
				else
				{
					...
					string s = "image=" + HttpUtility.UrlEncode(Convert.ToBase64String(inArray)) + "&language_type=" + str;
					byte[] bytes = Encoding.UTF8.GetBytes(s);
					HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create("https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic?access_token=" + ((JObject)JsonConvert.DeserializeObject(this.baidu_vip))["access_token"].ToString());
					httpWebRequest.Method = "POST";
					httpWebRequest.ContentType = "application/x-www-form-urlencoded; charset=UTF-8";
					httpWebRequest.Timeout = 8000;
					...
					string value = new StreamReader(responseStream, Encoding.GetEncoding("utf-8")).ReadToEnd();
					responseStream.Close();
					JArray jarray = JArray.Parse(((JObject)JsonConvert.DeserializeObject(value))["words_result"].ToString());
					this.checked_txt(jarray, 1, "words");
				}
			}
			catch
		...
		// Token: 0x060000C7 RID: 199 RVA: 0x0000C7A0 File Offset: 0x0000A9A0
		...
		// Token: 0x060000C8 RID: 200 RVA: 0x0000C840 File Offset: 0x0000AA40
		...
		// Token: 0x060000C9 RID: 201 RVA: 0x0000C888 File Offset: 0x0000AA88
		...
		// Token: 0x060000CA RID: 202 RVA: 0x0000C9F0 File Offset: 0x0000ABF0
		...
		// Token: 0x060000CB RID: 203 RVA: 0x0000CB34 File Offset: 0x0000AD34
		...
		// Token: 0x060000CC RID: 204 RVA: 0x0000CB80 File Offset: 0x0000AD80
		...
		// Token: 0x060000CD RID: 205 RVA: 0x0000CBE4 File Offset: 0x0000ADE4
		...
		// Token: 0x060000CE RID: 206 RVA: 0x0000CC4C File Offset: 0x0000AE4C
		public void OCR_sougou2()
		{
			try
			{
				...
				string value = new StreamReader(responseStream, Encoding.GetEncoding("utf-8")).ReadToEnd();
				responseStream.Close();
				JArray jarray = JArray.Parse(((JObject)JsonConvert.DeserializeObject(value))["result"].ToString());
		...
		// Token: 0x060000CF RID: 207 RVA: 0x0000CE3C File Offset: 0x0000B03C
		...
		// Token: 0x060000D1 RID: 209 RVA: 0x0000282C File Offset: 0x00000A2C
		...
		// Token: 0x060000D2 RID: 210 RVA: 0x0000283F File Offset: 0x00000A3F
		public bool Is_punctuation(string text)
		{
			return ",;:，（）、；".IndexOf(text) != -1;
		}

		// Token: 0x060000D3 RID: 211 RVA: 0x00002852 File Offset: 0x00000A52
		public bool has_punctuation(string text)
		{
			return ",;，；、<>《》()-（）".IndexOf(text) != -1;
		}

		// Token: 0x060000D4 RID: 212 RVA: 0x0000CE7C File Offset: 0x0000B07C
		public void checked_txt(JArray jarray, int lastlength, string words)
		{
			...
			this.split_txt = str + JObject.Parse(jarray[jarray.Count - 1].ToString())[words].ToString();
			this.typeset_txt = text.Replace("\r\n\r\n", "\r\n") + JObject.Parse(jarray[jarray.Count - 1].ToString())[words].ToString();
		}
		...
		// Token: 0x060000D7 RID: 215 RVA: 0x00002865 File Offset: 0x00000A65
		private void OCR_write_Click(object sender, EventArgs e)
		{
			this.OCR_foreach("手写");
		}

		// Token: 0x060000D8 RID: 216 RVA: 0x00002872 File Offset: 0x00000A72
		...
		// Token: 0x060000DA RID: 218 RVA: 0x0000D928 File Offset: 0x0000BB28
		public void OCR_baidu_acc()
		{
			...
			try
			{
				...
				else
				{
					...
					Image img = this.image_screen;
					byte[] inArray = this.OCR_ImgToByte(img);
					string s = "image=" + HttpUtility.UrlEncode(Convert.ToBase64String(inArray));
					byte[] bytes = Encoding.UTF8.GetBytes(s);
					HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create("https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic?access_token=" + ((JObject)JsonConvert.DeserializeObject(this.baidu_vip))["access_token"].ToString());
					httpWebRequest.Method = "POST";
					httpWebRequest.ContentType = "application/x-www-form-urlencoded; charset=UTF-8";
					...
					Stream responseStream = ((HttpWebResponse)httpWebRequest.GetResponse()).GetResponseStream();
					string value = text = new StreamReader(responseStream, Encoding.GetEncoding("utf-8")).ReadToEnd();
					responseStream.Close();
					JArray jarray = JArray.Parse(((JObject)JsonConvert.DeserializeObject(value))["words_result"].ToString());
					string text2 = "";
					for (int i = 0; i < jarray.Count; i++)
					...
					this.shupai_Right_txt = this.shupai_Right_txt + text2 + "\r\n";
					Thread.Sleep(600);
				}
			}
			catch
		...
		// Token: 0x060000DB RID: 219 RVA: 0x0000DBC0 File Offset: 0x0000BDC0
		...
		// Token: 0x060000DC RID: 220 RVA: 0x0000DEA8 File Offset: 0x0000C0A8
		...
		// Token: 0x060000DD RID: 221 RVA: 0x0000E014 File Offset: 0x0000C214
					...
					for (int i = 0; i < num; i++)
					{
						using (VectorOfPoint vectorOfPoint = vectorOfVectorOfPoint[i])
						{
							...
							if (rectangle.Size.Width > 1 && rectangle.Size.Height > 1)
							{
								...
								Rectangle srcRect = new Rectangle(x, 0, width, this.image_ori.Size.Height);
								Bitmap bitmap = new Bitmap(width + 70, srcRect.Size.Height);
								Graphics graphics = Graphics.FromImage(bitmap);
								graphics.FillRectangle(Brushes.White, 0, 0, bitmap.Size.Width, bitmap.Size.Height);
								graphics.DrawImage(this.image_ori, 30, 0, srcRect, GraphicsUnit.Pixel);
								Bitmap bitmap2 = Image.FromHbitmap(bitmap.GetHbitmap());
								bitmap2.Save("Data\\image_temp\\" + i.ToString() + ".jpg", ImageFormat.Jpeg);
								bitmap2.Dispose();
								bitmap.Dispose();
								graphics.Dispose();
							}
		...
		public Image FindBundingBox(Bitmap bitmap)
		{
			...
			return this.BoundingBox(image4, draw);
		}

		// Token: 0x060000DF RID: 223 RVA: 0x0000E3A0 File Offset: 0x0000C5A0
		...
		// Token: 0x060000E0 RID: 224 RVA: 0x0000E438 File Offset: 0x0000C638
		public void OCR_baidu_use()
		{
			...
			try
			{
				...
				this.shupai_Right_txt = (this.shupai_Right_txt + text + "\r\n").Replace("\r\n\r\n", "");
				this.shupai_Left_txt = text2.Replace("\r\n\r\n", "");
		...
		// Token: 0x060000E1 RID: 225 RVA: 0x0000E764 File Offset: 0x0000C964
		...
		// Token: 0x060000E2 RID: 226 RVA: 0x0000288C File Offset: 0x00000A8C
		public bool split_paragraph(string text)
		{
			return "。？！?!：".IndexOf(text) != -1;
		}

		// Token: 0x060000E3 RID: 227 RVA: 0x0000E9EC File Offset: 0x0000CBEC
		public void baidu_image_a(object objEvent)
		{
			try
			{
				...
				{
					Stream stream = File.Open("Data\\image_temp\\" + i.ToString() + ".jpg", FileMode.Open);
		...
		// Token: 0x060000E4 RID: 228 RVA: 0x0000EA64 File Offset: 0x0000CC64
		...
		// Token: 0x060000E5 RID: 229 RVA: 0x0000EAE4 File Offset: 0x0000CCE4
		private void DoWork(object state)
		{
			...
			this.shupai_Right_txt = string.Concat(new string[]
			{
				this.OCR_baidu_a,
				this.OCR_baidu_b,
				this.OCR_baidu_c,
		...
		// Token: 0x060000E6 RID: 230 RVA: 0x0000ECF4 File Offset: 0x0000CEF4
		public void OCR_baidu_use_B(Image imagearr)
		{
			try
			{
				...
				this.OCR_baidu_b = (this.OCR_baidu_b + text + "\r\n").Replace("\r\n\r\n", "");
				Thread.Sleep(10);
			}
			catch
			{
		...
		// Token: 0x060000E7 RID: 231 RVA: 0x0000EFE4 File Offset: 0x0000D1E4
		public void OCR_baidu_use_A(Image imagearr)
		{
			try
			{
				...
				this.OCR_baidu_a = (this.OCR_baidu_a + text + "\r\n").Replace("\r\n\r\n", "");
				Thread.Sleep(10);
			}
			catch
			{
		...
		// Token: 0x060000E8 RID: 232 RVA: 0x0000289F File Offset: 0x00000A9F
		...
		// Token: 0x060000E9 RID: 233 RVA: 0x0000F2D4 File Offset: 0x0000D4D4
		...
		// Token: 0x060000EA RID: 234 RVA: 0x0000F5BC File Offset: 0x0000D7BC
		public void OCR_baidu_use_E(Image imagearr)
		{
			try
			{
				...
				this.OCR_baidu_e = (this.OCR_baidu_e + text + "\r\n").Replace("\r\n\r\n", "");
				Thread.Sleep(10);
			}
			catch
			{
		...
		// Token: 0x060000EB RID: 235 RVA: 0x0000F8AC File Offset: 0x0000DAAC
		public void OCR_baidu_use_D(Image imagearr)
		{
			try
			{
				...
				this.OCR_baidu_d = (this.OCR_baidu_d + text + "\r\n").Replace("\r\n\r\n", "");
				Thread.Sleep(10);
			}
			catch
			{
		...
		// Token: 0x060000EC RID: 236 RVA: 0x0000FB9C File Offset: 0x0000DD9C
		public void OCR_baidu_use_C(Image imagearr)
		{
			try
			{
				...
				this.OCR_baidu_c = (this.OCR_baidu_c + text + "\r\n").Replace("\r\n\r\n", "");
				Thread.Sleep(10);
			}
			catch
			{
		...
		// Token: 0x060000ED RID: 237 RVA: 0x0000FE8C File Offset: 0x0000E08C
		...
		// Token: 0x060000EE RID: 238 RVA: 0x0000FF0C File Offset: 0x0000E10C
		...
		// Token: 0x060000EF RID: 239 RVA: 0x0000FF8C File Offset: 0x0000E18C
		...
		// Token: 0x060000F0 RID: 240 RVA: 0x0001000C File Offset: 0x0000E20C
		...
		// Token: 0x060000F1 RID: 241 RVA: 0x000102C8 File Offset: 0x0000E4C8
		...
		// Token: 0x060000F2 RID: 242 RVA: 0x00010388 File Offset: 0x0000E588
		private Image<Gray, byte> randon(Image<Gray, byte> imageInput)
		{
			...
			Image<Gray, byte> result = imageInput;
			for (int i = -20; i < 20; i++)
			{
				Image<Gray, byte> image = imageInput.Rotate((double)i, new Gray(1.0));
		...
		// Token: 0x060000F3 RID: 243 RVA: 0x000028B9 File Offset: 0x00000AB9
		public void SetGlobalProxy()
		{
			WebRequest.DefaultWebProxy = null;
		}

		// Token: 0x060000F4 RID: 244 RVA: 0x00010458 File Offset: 0x0000E658
		...
		// Token: 0x060000F5 RID: 245 RVA: 0x000104A8 File Offset: 0x0000E6A8
		...
		// Token: 0x060000F6 RID: 246 RVA: 0x000028C1 File Offset: 0x00000AC1
		...
		// Token: 0x060000F7 RID: 247 RVA: 0x000104FC File Offset: 0x0000E6FC
		...
		// Token: 0x060000F8 RID: 248 RVA: 0x000105C8 File Offset: 0x0000E7C8
		...
		// Token: 0x060000F9 RID: 249 RVA: 0x0001065C File Offset: 0x0000E85C
		public void 翻译文本()
		{
			if (inihelp.GetValue("配置", "快速翻译") == "True")
			{
				...
				try
				{
					...
					if (inihelp.GetValue("配置", "翻译接口") == "谷歌")
					{
						data = this.Translate_Google(this.trans_hotkey);
					}
					if (inihelp.GetValue("配置", "翻译接口") == "百度")
					{
						data = this.Translate_baidu(this.trans_hotkey);
					}
					if (inihelp.GetValue("配置", "翻译接口") == "腾讯")
					{
						data = this.Translate_Tencent(this.trans_hotkey);
					}
		...
		// Token: 0x060000FC RID: 252 RVA: 0x00011614 File Offset: 0x0000F814
		...
		// Token: 0x060000FD RID: 253 RVA: 0x0001168C File Offset: 0x0000F88C
		...
		// Token: 0x060000FF RID: 255 RVA: 0x00011760 File Offset: 0x0000F960
		...
		// Token: 0x06000100 RID: 256 RVA: 0x00002901 File Offset: 0x00000B01
		public bool Exist(bool[][] Colors, int x, int y)
		{
			return x >= 0 && y >= 0 && x < Colors.Length && y < Colors[0].Length && Colors[x][y];
		}

		// Token: 0x06000101 RID: 257 RVA: 0x00011814 File Offset: 0x0000FA14
		...
		// Token: 0x06000102 RID: 258 RVA: 0x0001186C File Offset: 0x0000FA6C
		...
		// Token: 0x06000103 RID: 259 RVA: 0x000118C4 File Offset: 0x0000FAC4
		...
		// Token: 0x06000104 RID: 260 RVA: 0x0001191C File Offset: 0x0000FB1C
		...
		// Token: 0x06000105 RID: 261 RVA: 0x00011974 File Offset: 0x0000FB74
		...
		// Token: 0x06000106 RID: 262 RVA: 0x00011A70 File Offset: 0x0000FC70
		...
		// Token: 0x06000107 RID: 263 RVA: 0x00011AB4 File Offset: 0x0000FCB4
		public static string ReFileNamekey(string strFilePath)
		{
			int startIndex = strFilePath.LastIndexOf('.');
			string format = strFilePath.Insert(startIndex, "_{0}");
			int num = 1;
		...
		// Token: 0x06000108 RID: 264 RVA: 0x00011B04 File Offset: 0x0000FD04
		...
		// Token: 0x06000109 RID: 265 RVA: 0x00011D4C File Offset: 0x0000FF4C
		...
		// Token: 0x0600010A RID: 266 RVA: 0x00011F00 File Offset: 0x00010100
		...
		// Token: 0x0600010B RID: 267 RVA: 0x00012064 File Offset: 0x00010264
		public Image FindBundingBox_fences(Bitmap bitmap)
		{
			...
			Image<Gray, byte> image4 = image3.Clone();
			CvInvoke.Canny(image3, image4, 255.0, 255.0, 5, true);
			Image image5 = this.BoundingBox_fences(image4, draw);
			Image<Gray, byte> image6 = new Image<Gray, byte>((Bitmap)image5);
			this.BoundingBox_fences_Up(image6);
			image.Dispose();
			image2.Dispose();
			image3.Dispose();
			image6.Dispose();
		...
		// Token: 0x0600010C RID: 268 RVA: 0x00012154 File Offset: 0x00010354
		...
		// Token: 0x0600010D RID: 269 RVA: 0x0000CE7C File Offset: 0x0000B07C
		...
		// Token: 0x0600010E RID: 270 RVA: 0x000121FC File Offset: 0x000103FC
		public void checked_location_sougou(JArray jarray, int lastlength, string words, string location)
		{
			...
			this.split_txt = text2.Replace("\r\n\r\n", "\r\n");
			this.typeset_txt = text.ToString();
		}

		// Token: 0x0600010F RID: 271 RVA: 0x00002920 File Offset: 0x00000B20
		public int split_char_x(string split_char)
		{
			return Convert.ToInt32(split_char.Split(new char[]
			{
				','
			})[0]);
		}

		// Token: 0x06000110 RID: 272 RVA: 0x000124F4 File Offset: 0x000106F4
		...
		// Token: 0x06000111 RID: 273 RVA: 0x0000293A File Offset: 0x00000B3A
		public int en_count(string text)
		{
			return Regex.Matches(text, "\\s+").Count + 1;
		}

		// Token: 0x06000112 RID: 274 RVA: 0x00012544 File Offset: 0x00010744
		...
		// Token: 0x06000113 RID: 275 RVA: 0x0001258C File Offset: 0x0001078C
		...
		// Token: 0x06000114 RID: 276 RVA: 0x0000294E File Offset: 0x00000B4E
		...
		// Token: 0x06000115 RID: 277 RVA: 0x0000296A File Offset: 0x00000B6A
		public void Trans_google_Click(object sender, EventArgs e)
		{
			this.Trans_foreach("谷歌");
		}

		// Token: 0x06000116 RID: 278 RVA: 0x00002977 File Offset: 0x00000B77
		public void Trans_baidu_Click(object sender, EventArgs e)
		{
			this.Trans_foreach("百度");
		}

		// Token: 0x06000117 RID: 279 RVA: 0x00012838 File Offset: 0x00010A38
		...
		public string GetBaiduHtml(string url, CookieContainer cookie, string refer, string content_length)
		{
			...
			{
				result = this.GetBaiduHtml(url, cookie, refer, content_length);
			}
			return result;
		}

		// Token: 0x06000119 RID: 281 RVA: 0x00012A30 File Offset: 0x00010C30
		private string Translate_baidu(string Text)
		{
			...
			try
			{
				...
				JArray jarray = JArray.Parse(((JObject)JsonConvert.DeserializeObject(httpHelper.GetHtml(item).Html))["trans"].ToString());
				for (int i = 0; i < jarray.Count; i++)
				{
					JObject jobject = JObject.Parse(jarray[i].ToString());
		...
		// Token: 0x0600011A RID: 282 RVA: 0x00002984 File Offset: 0x00000B84
		public void Trans_tencent_Click(object sender, EventArgs e)
		{
			this.Trans_foreach("腾讯");
		}

		// Token: 0x0600011B RID: 283 RVA: 0x00012C3C File Offset: 0x00010E3C
		...
		// Token: 0x0600011C RID: 284 RVA: 0x00012C8C File Offset: 0x00010E8C
		...
		// Token: 0x0600011D RID: 285 RVA: 0x00012E14 File Offset: 0x00011014
		private string Translate_Tencent(string strtrans)
		{
			...
			try
			{
				...
				JArray jarray = JArray.Parse(((JObject)JsonConvert.DeserializeObject(this.TencentPOST("https://fanyi.qq.com/api/translate", this.Content_Length(strtrans, fromlang, tolang))))["translate"]["records"].ToString());
				for (int i = 0; i < jarray.Count; i++)
				{
					JObject jobject = JObject.Parse(jarray[i].ToString());
		...
		// Token: 0x0600011E RID: 286 RVA: 0x0000207C File Offset: 0x0000027C
		public void webBrowser1_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
		{
		}

		// Token: 0x0600011F RID: 287 RVA: 0x00012F98 File Offset: 0x00011198
		...
		// Token: 0x06000121 RID: 289 RVA: 0x00012FF4 File Offset: 0x000111F4
		public string Post_GoogletHtml(string post_str)
		{
			string result = "";
			string requestUriString = "https://translate.google.cn/translate_a/single";
			byte[] bytes = Encoding.UTF8.GetBytes(post_str);
		...
		// Token: 0x06000123 RID: 291 RVA: 0x00013170 File Offset: 0x00011370
		public void OCR_baidu_table()
		{
			...
			try
			{
				...
				else
				{
					...
					memoryStream.Read(array, 0, (int)memoryStream.Length);
					memoryStream.Close();
					string s = "image=" + HttpUtility.UrlEncode(Convert.ToBase64String(array));
					byte[] bytes = Encoding.UTF8.GetBytes(s);
					HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create("https://aip.baidubce.com/rest/2.0/solution/v1/form_ocr/request?access_token=" + ((JObject)JsonConvert.DeserializeObject(this.baidu_vip))["access_token"].ToString());
					...
					string value = new StreamReader(responseStream, Encoding.GetEncoding("utf-8")).ReadToEnd();
					responseStream.Close();
					string post_str = "request_id=" + JObject.Parse(JArray.Parse(((JObject)JsonConvert.DeserializeObject(value))["result"].ToString())[0].ToString())["request_id"].ToString().Trim() + "&result_type=json";
					string text = "";
					while (!text.Contains("已完成"))
					{
						...
						Thread.Sleep(120);
						text = this.Post_Html("https://aip.baidubce.com/rest/2.0/solution/v1/form_ocr/get_request_result?access_token=" + ((JObject)JsonConvert.DeserializeObject(this.baidu_vip))["access_token"].ToString(), post_str);
					}
					if (!text.Contains("image recognize error"))
					{
						this.get_table(text);
		...
		// Token: 0x06000124 RID: 292 RVA: 0x00002991 File Offset: 0x00000B91
		public void OCR_table_Click(object sender, EventArgs e)
		{
			this.OCR_foreach("表格");
		}

		// Token: 0x06000125 RID: 293 RVA: 0x00013440 File Offset: 0x00011640
		private void get_table(string str)
		{
			...
			{
				JObject jobject = JObject.Parse(jarray[i].ToString());
				string value = jobject["column"].ToString().Replace("[", "").Replace("]", "").Replace("\r", "").Replace("\n", "").Trim();
				string value2 = jobject["row"].ToString().Replace("[", "").Replace("]", "").Replace("\r", "").Replace("\n", "").Trim();
			...
			for (int j = 0; j < jarray.Count; j++)
			{
				...
				string value3 = jobject2["column"].ToString().Replace("[", "").Replace("]", "").Replace("\r", "").Replace("\n", "").Trim();
				string value4 = jobject2["row"].ToString().Replace("[", "").Replace("]", "").Replace("\r", "").Replace("\n", "").Trim();
				array[j] = Convert.ToInt32(value3);
				array2[j] = Convert.ToInt32(value4);
				string text = jobject2["word"].ToString().Replace("[", "").Replace("]", "").Replace("\r", "").Replace("\n", "").Trim();
		...
		// Token: 0x06000126 RID: 294 RVA: 0x000137E8 File Offset: 0x000119E8
		private void setClipboard_table(string[,] wordo)
		{
			...
			{
				str = str + "\\clbrdrt\\brdrw15\\brdrs\\clbrdrl\\brdrw15\\brdrs\\clbrdrb\\brdrw15\\brdrs\\clbrdrr\\brdrw15\\brdrs \\cellx" + (i * 1800).ToString();
			}
			string text = "";
			string str2 = "\\pard\\intbl\\kerning2\\f0";
			string str3 = "\\row\\pard\\lang2052\\kerning0\\f1\\fs18\\par}";
			...
			this.RichBoxBody.rtf = str + str2 + text + str3;
		}

		// Token: 0x06000127 RID: 295 RVA: 0x000138E4 File Offset: 0x00011AE4
		public void Main_OCR_Thread_table()
		{
			this.ailibaba = new aliFMtable();
			TimeSpan timeSpan = new TimeSpan(DateTime.Now.Ticks);
			TimeSpan timeSpan2 = timeSpan.Subtract(this.ts).Duration();
			string str = string.Concat(new string[]
			{
		...
		// Token: 0x06000128 RID: 296 RVA: 0x00013AE0 File Offset: 0x00011CE0
		private void setClipboard_Table(string[,] wordo, int[] cc)
		{
			...
			{
				num += cc[i - 1] * 17;
				str = str + "\\clbrdrt\\brdrw15\\brdrs\\clbrdrl\\brdrw15\\brdrs\\clbrdrb\\brdrw15\\brdrs\\clbrdrr\\brdrw15\\brdrs \\cellx" + num.ToString();
			}
			string text = "";
			string str2 = "\\pard\\intbl\\kerning2\\f0";
			string str3 = "\\row\\pard\\lang2052\\kerning0\\f1\\fs18\\par}";
		...
		// Token: 0x06000129 RID: 297 RVA: 0x00013BE0 File Offset: 0x00011DE0
		public string Translate_Googlekey(string text)
		{
			...
			try
			{
				...
				string post_str = string.Concat(new string[]
				{
					"client=gtx&sl=",
					text3,
					"&tl=",
				...
				JArray jarray = (JArray)JsonConvert.DeserializeObject(this.Post_GoogletHtml(post_str));
				int count = ((JArray)jarray[0]).Count;
				for (int i = 0; i < count; i++)
				{
					text2 += jarray[0][i][0].ToString();
		...
		// Token: 0x0600012A RID: 298 RVA: 0x0000299E File Offset: 0x00000B9E
		public void OCR_baidutable_Click(object sender, EventArgs e)
		{
			this.OCR_foreach("百度表格");
		}

		// Token: 0x0600012B RID: 299 RVA: 0x000029AB File Offset: 0x00000BAB
		public void OCR_ailitable_Click(object sender, EventArgs e)
		{
			this.OCR_foreach("阿里表格");
		}

		// Token: 0x0600012C RID: 300 RVA: 0x00013D84 File Offset: 0x00011F84
		...
		// Token: 0x0600012D RID: 301 RVA: 0x000029B8 File Offset: 0x00000BB8
		public static byte[] ImageToByteArray(Image img)
		{
			return (byte[])new ImageConverter().ConvertTo(img, typeof(byte[]));
		}

		// Token: 0x0600012E RID: 302 RVA: 0x000029D4 File Offset: 0x00000BD4
		public static Stream BytesToStream(byte[] bytes)
		{
			return new MemoryStream(bytes);
		}

		// Token: 0x0600012F RID: 303 RVA: 0x00013E74 File Offset: 0x00012074
		public void OCR_ali_table()
		{
			...
			try
			{
				...
				string str = Convert.ToBase64String(new BinaryReader(stream).ReadBytes(Convert.ToInt32(stream.Length)));
				stream.Close();
				string post_str = "{\n\t\"image\": \"" + str + "\",\n\t\"configure\": \"{\\\"format\\\":\\\"html\\\", \\\"finance\\\":false}\"\n}";
				string url = "https://predict-pai.data.aliyun.com/dp_experience_mall/ocr/ocr_table_parse";
				text = this.Post_Html_final(url, post_str, value);
				this.typeset_txt = ((JObject)JsonConvert.DeserializeObject(this.Post_Html_final(url, post_str, value)))["tables"].ToString().Replace("table tr td { border: 1px solid blue }", "table tr td {border: 0.5px black solid }").Replace("table { border: 1px solid blue }", "table { border: 0.5px black solid; border-collapse : collapse}\r\n");
				this.RichBoxBody.Text = "[消息]：表格已复制到粘贴板！";
			}
			catch
			{
		...
		// Token: 0x06000130 RID: 304 RVA: 0x00013F9C File Offset: 0x0001219C
		...
		// Token: 0x06000131 RID: 305 RVA: 0x00014018 File Offset: 0x00012218
		...
		// Token: 0x06000132 RID: 306 RVA: 0x00014114 File Offset: 0x00012314
		public void CopyHtmlToClipBoard(string html)
		{
			...
			string data = new FmMain.HtmlToText().Convert(html);
			dataObject.SetData(DataFormats.Text, data);
			Clipboard.SetDataObject(dataObject);
		}

		// Token: 0x06000133 RID: 307 RVA: 0x0001422C File Offset: 0x0001242C
		public static string Encript(string functionName, object[] pams)
		{
			string code = File.ReadAllText("sign.js");
		...
		// Token: 0x06000134 RID: 308 RVA: 0x00014268 File Offset: 0x00012468
		...
		// Token: 0x06000135 RID: 309 RVA: 0x000029DC File Offset: 0x00000BDC
		private void OCR_Mathfuntion_Click(object sender, EventArgs e)
		{
			this.OCR_foreach("公式");
		}

		// Token: 0x06000136 RID: 310 RVA: 0x000142B4 File Offset: 0x000124B4
		public void OCR_Math()
		{
			...
			try
			{
				...
				string value = new StreamReader(responseStream, Encoding.GetEncoding("utf-8")).ReadToEnd();
				responseStream.Close();
				string text = "$" + ((JObject)JsonConvert.DeserializeObject(value))["latex_styled"].ToString() + "$";
				this.split_txt = text;
		...
		public class AutoClosedMsgBox
		{
			...
			// Token: 0x06000146 RID: 326 RVA: 0x000029E9 File Offset: 0x00000BE9
			...
			// Token: 0x06000147 RID: 327 RVA: 0x000029E9 File Offset: 0x00000BE9
		...
		{
			// Token: 0x06000149 RID: 329 RVA: 0x00014464 File Offset: 0x00012664
			static PinYin()
			{
				...
				}))
				{
					...
					string value = text2.Substring(1 + text2.IndexOf(","));
					FmMain.PinYin.hashtable[key] = value;
				}
			}

			// Token: 0x0600014A RID: 330 RVA: 0x000144D8 File Offset: 0x000126D8
			public static string ToPinYin(string hanzi)
			{
				...
				foreach (char c in hanzi)
				{
					...
					{
						text = (FmMain.PinYin.hashtable[c.ToString()] as string);
					}
					if (FmMain.contain_en(c.ToString()))
					{
						stringBuilder.Append(text);
					}
					else if (FmMain.contain_en(str))
					{
						stringBuilder.Append(" " + text + " ");
					}
					else
		...
		{
			// Token: 0x0600015B RID: 347 RVA: 0x000145CC File Offset: 0x000127CC
			static HtmlToText()
			{
			...
			// Token: 0x0600015C RID: 348 RVA: 0x0001489C File Offset: 0x00012A9C
			public string Convert(string html)
			{
				...
				while (!this.EndOfText)
				{
					if (this.Peek() == '<')
					{
						...
						string s;
						if (FmMain.HtmlToText._tags.TryGetValue(text, out s))
						{
							this._text.Write(s);
						}
			...
			// Token: 0x0600015D RID: 349 RVA: 0x000149EC File Offset: 0x00012BEC
			protected string ParseTag(out bool selfClosing)
			{
				...
				if (this.Peek() == '<')
				{
					...
					result = this._html.Substring(pos, this._pos - pos).ToLower();
			...
			// Token: 0x0600015E RID: 350 RVA: 0x00014AC8 File Offset: 0x00012CC8
			...
			// Token: 0x06000160 RID: 352 RVA: 0x00002A8C File Offset: 0x00000C8C
			protected char Peek()
			{
			...
			// Token: 0x06000161 RID: 353 RVA: 0x00002AB4 File Offset: 0x00000CB4
			protected void MoveAhead()
			{
				this._pos = Math.Min(this._pos + 1, this._html.Length);
			}

			// Token: 0x06000162 RID: 354 RVA: 0x00002AD4 File Offset: 0x00000CD4
			...
			// Token: 0x06000163 RID: 355 RVA: 0x00002AEB File Offset: 0x00000CEB
			...
			// Token: 0x06000164 RID: 356 RVA: 0x00014B28 File Offset: 0x00012D28
			...
			{
				// Token: 0x06000166 RID: 358 RVA: 0x00002B0C File Offset: 0x00000D0C
				public TextBuilder()
				{
				...
				// Token: 0x06000169 RID: 361 RVA: 0x00002B67 File Offset: 0x00000D67
				public void Clear()
				{
					this._text.Length = 0;
				...
				// Token: 0x0600016A RID: 362 RVA: 0x00014BA0 File Offset: 0x00012DA0
				...
				// Token: 0x0600016B RID: 363 RVA: 0x00014BD0 File Offset: 0x00012DD0
				...
				// Token: 0x0600016C RID: 364 RVA: 0x00014C4C File Offset: 0x00012E4C
				...
				// Token: 0x0600016D RID: 365 RVA: 0x00002B88 File Offset: 0x00000D88
